...
class Constants: NSObject {
    ...
    static func nicknameFontInMessage() -> UIFont {
        return UIFont(name: "Avenir Heavy", size: 12.0)!
    }
    ...
    static func messageDateFont() -> UIFont {
        return UIFont(name: "Avenir Heavy", size: 10.0)!
    }
    ...
    static func incomingMessageColor() -> UIColor {
        return UIColor(red: 199.0/255.0, green: 199.0/255.0, blue: 199.0/255.0, alpha: 0.5)
    }

...
class CommonClass: NSObject {
    ...
    func getScaledWithOutMinimum(forFont name: String,textStyle: UIFontTextStyle)->UIFont{
...
extension UIView{
    ...
    func validField(){
        self.setBorder(color: .green)
    }
    func showMessageLabel(msg:String = Vocabulary.getWordFromKey(key:"nothingToSee"),backgroundColor:UIColor = UIColor.init(white:1, alpha: 1),headerHeight:CGFloat = 0.0){
        DispatchQueue.main.async {
            let label = UILabel()
            label.text = msg
